...
class Browser(QMainWindow):
    def __init__(self):
        ...
        self.version_label = QLabel("V0.4 (alpha)")
        self.version_label.setStyleSheet("color: gray; font-size: 10px;")
        self.version_label.setAlignment(Qt.AlignRight | Qt.AlignTop)  # Align top right
        self.statusBar().addPermanentWidget(self.version_label)  # Add to status bar
